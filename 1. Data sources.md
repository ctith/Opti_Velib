...
=> trop long et fastidieux car limite de temps lors de l'importation des données lors de l'étape 3 donc abandon.
=> script python pour écrire les données SQL en JSON : trop long développement aussi donc non choisi !
